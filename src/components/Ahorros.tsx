...
export const Ahorros: React.FC<AhorrosProps> = ({ familiaId, mesSeleccionado }) => {
  ...
  const textTitle = esOscuro ? '#818cf8' : '#4f46e5';
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px', marginBottom: '8px' }}>
              <div>
                ...
                <input type="text" value={meta} onChange={e => setMeta(e.target.value)} required style={{ width: '100%', padding: '9px', borderRadius: '8px', border: `1px solid ${borderCard}`, background: bgInput, color: textPrimary, outline: 'none', boxSizing: 'border-box' }} />
              </div>
              <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px', marginBottom: '8px' }}>
              <div>
                ...
                <input type="text" value={walletOrigen} onChange={e => setWalletOrigen(e.target.value)} style={{ width: '100%', padding: '9px', borderRadius: '8px', border: `1px solid ${borderCard}`, background: bgInput, color: textPrimary, outline: 'none', boxSizing: 'border-box' }} />
              </div>
              <div>
                <label style={{ display: 'block', fontSize: '9px', fontWeight: '800', color: textLabel, marginBottom: '3px' }}>Wallet Destino</label>
                <input type="text" value={walletDestino} onChange={e => setWalletDestino(e.target.value)} style={{ width: '100%', padding: '9px', borderRadius: '8px', border: `1px solid ${borderCard}`, background: bgInput, color: textPrimary, outline: 'none', boxSizing: 'border-box' }} />
              </div>
            </div>
            ...
            <div style={{ marginBottom: '8px' }}>
              ...
              <input type="text" value={concepto} onChange={e => setConcepto(e.target.value)} placeholder="Ej. Ahorro quincenal..." style={{ width: '100%', padding: '9px', borderRadius: '8px', border: `1px solid ${borderCard}`, background: bgInput, color: textPrimary, outline: 'none', boxSizing: 'border-box' }} />
            </div>
