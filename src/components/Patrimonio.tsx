        ...
        <div style={{ background: bgCard, border: `1px solid ${borderCard}`, borderRadius: '14px', padding: '16px', color: textPrimary, transition: 'all 0.3s' }}>
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ marginBottom: '8px' }}>
              ...
              <input type="text" required value={nombre} onChange={e => setNombre(e.target.value)} placeholder="Ej. Terreno, Vehículo, Joyas..." style={{ width: '100%', padding: '9px', borderRadius: '8px', border: `1px solid ${borderCard}`, background: bgInput, color: textPrimary, outline: 'none', boxSizing: 'border-box' }} />
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px', marginBottom: '8px' }}>
              <div>
                ...
                <input type="number" step="0.01" required value={valor} onChange={e => setValor(e.target.value)} placeholder="0.00" style={{ width: '100%', padding: '9px', borderRadius: '8px', border: `1px solid ${borderCard}`, background: bgInput, color: textPrimary, outline: 'none', boxSizing: 'border-box' }} />
              </div>
              <div>
            ...
            <div style={{ marginBottom: '8px' }}>
              ...
              <input type="text" value={fotoUrl} onChange={e => setFotoUrl(e.target.value)} placeholder="Ej. URL de la foto..." style={{ width: '100%', padding: '9px', borderRadius: '8px', border: `1px solid ${borderCard}`, background: bgInput, color: textPrimary, outline: 'none', boxSizing: 'border-box' }} />
            </div>
